...
print("-" * 90)
print("VERDICT: PASS MOSTLY LEGITIMATE")
print()
...
print()
print("RECOMMENDATION: WARNING KEEP these products (modern legitimate footwear)")
print()
print()
...
print()
print("RECOMMENDATION: WARNING KEEP these products (legitimate rubber-coated clothing)")
print()
...
with open(REPORT_FILE, 'w') as f:
    ...
    f.write("**ERROR NO - This is LEGITIMATE modern footwear!**\n\n")
    ...
    f.write("\n### Recommendation\n\n")
    f.write("PASS **KEEP THESE PRODUCTS**\n\n")
    ...
    f.write("### Is This an Error?\n\n")
    f.write("**ERROR NO - This is LEGITIMATE for many clothing types!**\n\n")
    ...
    f.write("|-------|----------|---------|--------|\n")
    f.write(f"| Footwear without typical materials | {len(footwear_without_typical):,} | PASS Legitimate | KEEP |\n")
    f.write(f"| Clothing with rubber materials | {len(clothing_with_rubber):,} | PASS Legitimate | KEEP |\n")
    f.write(f"| **TOTAL** | **{len(footwear_without_typical) + len(clothing_with_rubber):,}** | **PASS All Legitimate** | **NO ACTION NEEDED** |\n\n")
...
print()
print("SUMMARY:")
print(f"  Issue 1: {len(footwear_without_typical):,} footwear without typical materials -> PASS LEGITIMATE")
print(f"  Issue 2: {len(clothing_with_rubber):,} clothing with rubber materials -> PASS LEGITIMATE")
print(f"  Total:   {len(footwear_without_typical) + len(clothing_with_rubber):,} products")
print()
print("RECOMMENDATION: WARNING KEEP ALL - These represent legitimate modern products")
print()
print(f"Data Detailed report: {REPORT_FILE}")
print()

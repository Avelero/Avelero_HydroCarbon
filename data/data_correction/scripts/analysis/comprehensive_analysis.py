...
if not os.path.exists(INPUT_CSV):
    print(f"ERROR Error: File not found: {INPUT_CSV}")
    sys.exit(1)
...
print("Processing Converting numeric columns...")
...
if missing_weight > 0 or missing_distance > 0:
    ...
    print(f"OK After removing rows with missing numeric values: {len(df):,} rows")
print()
...
print("=" * 80)
print()
print(f"Data Analyzed {len(df):,} products")

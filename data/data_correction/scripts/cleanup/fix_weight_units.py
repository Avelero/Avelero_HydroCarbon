...
if low_count > 0:
    ...
    print(f"OK Fixed {low_count:,} low weight products")
...
if high_count > 0:
    ...
    print(f"OK Fixed {high_count:,} high weight products")
...
print(f"Saving Saving corrected dataset to: {OUTPUT_CSV}")
df_corrected.to_csv(OUTPUT_CSV, index=False, quoting=1, escapechar='\\')
print(f"OK Saved!\n")

# Save report
print(f"Data Saving correction report to: {REPORT_FILE}")
with open(REPORT_FILE, 'w') as f:
    ...
    f.write("=" * 80 + "\n")
    f.write("OK WEIGHT UNIT CORRECTION COMPLETE\n")
    f.write("=" * 80 + "\n")
...
print("=" * 80)
print("OK WEIGHT UNIT CORRECTION COMPLETE")
print("=" * 80)
print()
...
print()
print(f"PASS All weights are now in KILOGRAMS")

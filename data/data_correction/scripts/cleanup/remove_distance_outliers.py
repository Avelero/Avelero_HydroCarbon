...
print(f"LOCATION Reference: Earth circumference = {EARTH_CIRCUMFERENCE:,} km")
print(f"Target Threshold: Removing products with distance > {DISTANCE_THRESHOLD:,} km")
print()
...
print(f"OK Removed {outlier_count:,} products")
...
if remaining_outliers == 0:
    print("PASS All distance outliers removed successfully!")
else:
    print("WARNING Some outliers may remain")
print()
...
print(f"OK Saved {final_count:,} products!\n")
...
with open(REPORT_FILE, 'w') as f:
    ...
    f.write(f"PASS **All distances <= {DISTANCE_THRESHOLD:,} km** (physically plausible)\n\n")
    f.write(f"PASS **Maximum distance**: {distance_stats_after['max']:.2f} km (within Earth's circumference)\n\n")
    f.write(f"PASS **Mean distance**: {distance_stats_after['mean']:.2f} km (reasonable for global supply chains)\n\n")
...
print("=" * 80)
print("OK DISTANCE OUTLIER REMOVAL COMPLETE")
print("=" * 80)
print()
...
print()
print(f"PASS All distances now <= {DISTANCE_THRESHOLD:,} km")
print(f"PASS Maximum distance: {distance_stats_after['max']:.2f} km")
print()
